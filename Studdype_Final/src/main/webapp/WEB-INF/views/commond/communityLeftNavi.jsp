...
<body>
    ...
    <div class="left-navigation">
        ...
        <ul class="leftnavi-ul">
            ...
            <li class="leftnavi-item"> <img src="./resources/assets/img/category_searchBook.png"><input type="button" value="도서검색" onclick="location.href='bookboard.do'" class="navBtn" id="book"></li>
