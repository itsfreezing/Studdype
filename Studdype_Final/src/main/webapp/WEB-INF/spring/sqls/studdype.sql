...
select * from member;
INSERT INTO MEMBER VALUES(MEMBERSEQ.NEXTVAL,'ADMIN','ADMIN','관리자','970614-2177728','F','010-1234-5678','ehldks2104@gmail.com');
------지역 카테고리 
---시
...
CREATE TABLE LOCATION_GU(
    ...
    GU_NAME VARCHAR(50) NOT NULL UNIQUE, -- 구 이름    
