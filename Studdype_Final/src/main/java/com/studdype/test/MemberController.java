...
import com.studdype.test.model.biz.MemberBiz;
...
public class MemberController {
	...
	MemberBiz memberbiz;
      ...
      public ModelAndView mailSending(HttpServletRequest request, String e_mail, HttpServletResponse response_email) throws IOException {
          ...
          String setfrom = "ehldks2104@gmail.com";
  ...
  @RequestMapping(value = "/member/email_injeung.do{dice}", method = RequestMethod.POST)
  public ModelAndView email_injeung(String email_injeung, @PathVariable String dice, HttpServletResponse response_equals) throws IOException {
      ...
      mv.setViewName("/member/email_injeung.do");
