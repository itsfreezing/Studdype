...
public class MailSender {
	...
	public void sendExtraPwMail(MemberDto member) {
		...
		String html = "<table style='width:700px; margin-left:20px;'>"
					...
					+"<td style='background-color: #f5f6f5; color:#80878d'>아이디</td><td>"+member.getMem_id()+"</td><td style='background-color: #f5f6f5; color:#80878d'>임시비밀번호</td><td>"+member.getMem_pw()+"</td>"
