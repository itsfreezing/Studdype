...
public class MeetDto {
	...
	public MeetDto(int meet_no, int s_no, String meet_title, int meet_writer, String meet_content, String meet_addr,
			...
			String vote_enddate, int meet_cnt, String meet_keyword) {
		super();
	...
	public String getMeet_keyword() {
		return meet_keyword;
	}

	public void setMeet_keyword(String meet_keyword) {
		this.meet_keyword = meet_keyword;
	}
